...
export default function ToolsmodelCard({
  name,
  icon,
  level,
  years,
  ...
  return (
    <div className="w-72 h-80 bg-white rounded-lg shadow-lg overflow-hidden border-2 border-gray-800">
      {/* Header avec icône */}
      <div
        className={`${color} p-6 flex items-center justify-center border-b-2 border-gray-800`}
      >
        {icon ? (
          <img src={icon} alt={name} className="w-24 h-20 object-contain" />
        ) : (
